...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,react,astro,nodejs,express,dotnet,mongodb,mysql,dart,flutter,java,angular)](https://skillicons.dev)

## Other Skills and Technologies

[![Other Skills and Technologies](https://skillicons.dev/icons?i=figma,git,github,gitlab,npm,pnpm,ubuntu,visualstudio,vscode,vite,postman,vercel)](https://skillicons.dev)
